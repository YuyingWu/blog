...
const list = [{
  content: `
    <img src="http://sinacloud.net/blog-image/i-love-you.jpg" />
  `
}, {
  content: `
    <h1>Ma puce,</h1>
    ...
    <p style="font-weight: 700;">Votre Qing</p>
  `,
}, {
  content: `
    <h1>Ma puce,</h1>
  ...
  content: `
    <h1>Ma puce,</h1>
    <p>je t’aime.</p>
    <p style="font-weight: 700;">Votre 大猫</p>
  `,
}, {
  content: `
    <h1>Bonjour, Qing,</h1>
    <p>nice to meet you.</p>
<p style="font-weight: 700;">Yours,<br/>大猫</p>
  `,
}, {
  content: `
    <h1>初见</h1>
